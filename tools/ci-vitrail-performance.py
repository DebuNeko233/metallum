...
if 'tools/freeze-world.py" "$saves_dir/$world_name" --still-life' not in launcher:
    raise SystemExit(
        "the harness does not freeze the world it stages, or leaves its entities in it, so two launches "
        "draw two scenes"
    )
