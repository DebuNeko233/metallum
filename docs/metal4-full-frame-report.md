...
cold runs:        539 processes, 2396 probes (378 processes and 1619 probes through the compute round, then the
...
warm probes:      1390 in thirty-five processes  field failures: 18 all-time, all in one process of the
...
this round:       **two shapes were wrong, and both are fixed**: the storage smoke depended on a re-pointed
