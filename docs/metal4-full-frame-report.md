...
cold runs:        599 processes, 2496 probes (378 processes and 1619 probes through the compute round, then the
...
warm probes:      1430 in thirty-seven processes  field failures: 18 all-time, all in one process of the
...
this round:       **the read side of the compute boundary, section 60's list finished, and the chain of two
                  dispatches measured**: seven dependency fields in the census, 50 of 50 each, 0 failures. The
                  round before this one: **the read side of the compute boundary, and section 60's list
                  finished**: a dispatch that
