...
cold runs:        569 processes, 2446 probes (378 processes and 1619 probes through the compute round, then the
...
warm probes:      1410 in thirty-six processes  field failures: 18 all-time, all in one process of the
...
this round:       **the read side of the compute boundary, and section 60's list finished**: a dispatch that
