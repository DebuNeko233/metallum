...
What remains open is PHASE 17 real shader-pack compatibility, and it is the merge blocker for both Draft PRs. A green build, a successful launch or a clean log is not evidence that Metal execution is correct: that requires the reviewed screenshot and reference material the companion repository's PHASE 17 policy defines.
